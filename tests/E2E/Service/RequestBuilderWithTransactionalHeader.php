...
final readonly class RequestBuilderWithTransactionalHeader implements RequestBuilderInterface
{
    ...
    public function buildRequest(
        ...
        return $request->withAddedHeader('sw-remote-admin-api-test-runner-transactional', 'true');
    }
}
